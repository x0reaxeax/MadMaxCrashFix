...
DWORD WINAPI ThreadProc(
    ...
    LPVOID lpTargetAddress = (LPVOID) 0x142F5C46E;
    ...
    while (EXIT_SUCCESS != memcmp(
        lpTargetAddress,
        abOriginalBytes,
        sizeof(abOriginalBytes)
    )) {
        // Just wait until Shitnuvo decrypts the target memory.
        // There should be enough time to apply the patch
